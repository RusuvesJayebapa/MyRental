...
public class SessionManager
{
    ...
    {
        editor.putLong("KEY_AADHAR_NUMBER", aadharNumber);
        editor.commit();
    }
    public Long getAadharNumber() { return sharedPreferences.getLong("KEY_AADHAR_NUMBER", 0); }

    public void setPassword(String aadharNumber)
    {
        editor.putString("KEY_PASSWORD", aadharNumber);
        editor.commit();
    }
