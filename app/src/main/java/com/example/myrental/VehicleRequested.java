...
public class VehicleRequested extends AppCompatActivity
{
    ...
    private void filterDialog()
    {
        ...
        final ArrayAdapter<String> vehicleClassAdapter = new ArrayAdapter<String>(VehicleRequested.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.vehicle_class));
        ...
        final ArrayAdapter<String> fuelTypeAdapter = new ArrayAdapter<String>(VehicleRequested.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.fuel));
    ...
    {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("AddVehicleOwner");
        databaseReference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                for(int i = 0; i < request.size(); i++)
                {
                    for (DataSnapshot ds : dataSnapshot.getChildren()) {
                        HashMap<String, Object> hashMap = (HashMap<String, Object>) ds.getValue();
                        if (hashMap.get("Status").equals("NO") && hashMap.get("Id").equals(request.get(i).get("Vehicle_Id")))
                        {
    ...
    private void display()
    {
        if(arrayList.size() > 0)
        {
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(VehicleRequested.this);
    ...
    class MyNewAdapter extends RecyclerView.Adapter<MyNewAdapter.MyViewHolder> implements Filterable
    {
            ...
            holder.request.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            request(imageListFilter.get(position));
                        }
                    });
        ...
        private void request(final HashMap<String, Object> a)
        {
