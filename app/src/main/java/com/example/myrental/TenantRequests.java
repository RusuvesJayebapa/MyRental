...
public class TenantRequests extends AppCompatActivity
{
    ...
    private void filterDialog()
    {
        ...
        final ArrayAdapter<String> categoryAdapter = new ArrayAdapter<String>(TenantRequests.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.category));
        ...
        final ArrayAdapter<String> propertyTypeAdapter = new ArrayAdapter<String>(TenantRequests.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.property_type));
        ...
        requestOwner.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren())
                {
                    ...
                    if (hashMap.get("Requestor_Id").toString().equals(sessionManager.getUID()) && hashMap.get("Request_Status").toString().equals("NO"))
                    {
                        request.add(hashMap);
                    }
                }
        ...
        databaseReference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                for (int i = 0; i < request.size(); i++)
                {
                    ...
                    {
                        HashMap<String, Object> hashMap = (HashMap<String, Object>) ds.getValue();
                        if (hashMap.get("Status").equals("NO") && hashMap.get("Id").toString().equals(request.get(i).get("Property_Id")))
                        {
    ...
    private void display()
    {
        if(arrayList.size() > 0)
        {
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(TenantRequests.this);
    ...
    class MyNewAdapter extends RecyclerView.Adapter<MyNewAdapter.MyViewHolder> implements Filterable
    {
        ...
        public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
            ...
            TextView textView = new TextView(TenantRequests.this);
            ...
            reference.addValueEventListener(new ValueEventListener()
            {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot ds : dataSnapshot.getChildren())
                    {
                        ...
                        if (requestOwner.get("Property_Id").equals(imageListFilter.get(position).get("Id")))
                        {
        ...
        private void request(final HashMap<String, Object> a, String key)
        {
            ...
            if (key.equals("1"))
            {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TenantRequests.this, new DatePickerDialog.OnDateSetListener()
                {
                    @Override
                    public void onDateSet(DatePicker view, final int year, int month, int dayOfMonth) {
                        ...
                        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(TenantRequests.this);
                        final String Start_Date;
                        final TextView DOB = new TextView(TenantRequests.this);
                        DOB.setTextColor(Color.GREEN);
                        DOB.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16f);
                        LinearLayout linearLayout = new LinearLayout(TenantRequests.this);
        ...
        class MyViewHolder extends RecyclerView.ViewHolder
        {
            ...
            TextView clause, applicance_furniture, landlord, landlord_address, landlord_mobile, landlord_age, landlord_occupation, property_address, property_type, property_rent, property_area, property_deposit, line1, line2;
            ImageView call;
            Button request;
